...
from mailing.jobs import daily_tasks, weekly_tasks, monthly_tasks
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        scheduler.add_job(
            daily_tasks,
            trigger=CronTrigger(second="*/30"),  # Для демонстрации работы Every 30 secoonds
            id="daily_30_sec_job",
            max_instances=1,
            replace_existing=True,
        )
        logger.info("Added job 'daily_30_sec_job'.")
